...
test('Successfully generate screenshot', function () { return __awaiter(_this, void 0, void 0, function () {
    var spy, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                spy = jest.spyOn(workerFunctions, 'takeScreenshot');
                spy.mockResolvedValue(false);
                return [4 /*yield*/, screenshotWorker({
                        id: '1',
...
test('Failed generate screenshot', function () { return __awaiter(_this, void 0, void 0, function () {
    var spy, result;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, screenshotWorker({
                        ...
                        moveToFailed: function () { return true; },
                    })];
            case 1:
                result = _a.sent();
                expect(result).toEqual({
